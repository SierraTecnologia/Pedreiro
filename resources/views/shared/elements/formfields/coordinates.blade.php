        ...
        <div>
            <div class="form-group">
                <div class="col-md-5" v-if="showAutocomplete">
                    <label class="control-label">{{ __('pedreiro::generic.find_by_place') }}</label>
                    <input
                        class="form-control"
                        type="text"
                ...
                <div class="col-md-2" v-if="showLatLng">
                    <label class="control-label">{{ __('pedreiro::generic.latitude') }}</label>
                    <input
                        class="form-control"
                        type="number"
                        step="any"
                ...
                <div class="col-md-2" v-if="showLatLng">
                    <label class="control-label">{{ __('pedreiro::generic.longitude') }}</label>
                    <input
                        class="form-control"
                        type="number"
                        step="any"
