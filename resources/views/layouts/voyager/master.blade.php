...
if (! is_object(Auth::user())) {
    $user_avatar = '';
} elseif (\Illuminate\Support\Str::startsWith(Auth::user()->avatar, 'http://') || \Illuminate\Support\Str::startsWith(Auth::user()->avatar, 'https://')) {
...
@include('pedreiro::partials.app-footer')
