<!DOCTYPE html>
<html lang="{{ \Illuminate\Support\Facades\Config::get('app.locale') }}" dir="{{ __('pedreiro::generic.is_rtl') == 'true' ? 'rtl' : 'ltr' }}">
<head>
    <meta charset="utf-8">
    ...
    @if (__('pedreiro::generic.is_rtl') == 'true')
    ...
    <div class="row">
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <div class="copy animated fadeIn">
                            ...
                            <p>{{ Facilitador::setting('admin.description', __('pedreiro::login.welcome')) }}</p>
                        </div>
        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar">
            ...
            <div class="login-container">
                ...
                <p>{{ __('pedreiro::login.signin_below') }}</p>

                <form action="{{ route('rica.login') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="form-group form-group-default" id="emailGroup">
                        <label>{{ __('pedreiro::generic.email') }}</label>
                        <div class="controls">
                            <input type="text" name="email" id="email" value="{{ old('email') }}" placeholder="{{ __('pedreiro::generic.email') }}" class="form-control" required>
                         </div>
                    </div>

                    <div class="form-group form-group-default" id="passwordGroup">
                        <label>{{ __('pedreiro::generic.password') }}</label>
                        <div class="controls">
                            <input type="password" name="password" placeholder="{{ __('pedreiro::generic.password') }}" class="form-control" required>
                        </div>
                    </div>

                    <div class="form-group" id="rememberMeGroup">
                        <div class="controls">
                        <input type="checkbox" name="remember" id="remember" value="1"><label for="remember" class="remember-me-text">{{ __('pedreiro::generic.remember_me') }}</label>
                        </div>
                    </div>
                    
                    <button type="submit" class="btn btn-block login-button">
                        <span class="signingin hidden"><span class="facilitador-refresh"></span> {{ __('pedreiro::login.loggingin') }}...</span>
                        <span class="signin">{{ __('pedreiro::generic.login') }}</span>
                    </button>
