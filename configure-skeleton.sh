...
vendor_name_unsantized=$(ask_question "Vendor name" "ricasolucoes")
...
echo
files=$(grep -E -r -l -i ":author|:vendor|:package|ricasolucoes|pedreiro" --exclude-dir=vendor ./*  | grep -v "$script_name")
