...
class PedreiroBaseController extends Base
{
    ...
    public function index(Request $request)
    {
        ...
        if (! empty($dataTypeContent->first())) {
            foreach (Pedreiro::actions() as $action) {
    ...
    public function show(Request $request, $id)
    {
        ...
        return Pedreiro::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Pedreiro::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable'));
    }
