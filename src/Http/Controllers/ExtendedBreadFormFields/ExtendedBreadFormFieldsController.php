...
use Pedreiro\Http\Controllers\Admin\Controller;
use Pedreiro\Http\Controllers\Admin\PedreiroBaseController;

class ExtendedBreadFormFieldsController extends PedreiroBaseController
{
    ...
    public function insertUpdateData($request, $slug, $rows, $data)
    {
        ...
        $new_data = PedreiroBaseController::insertUpdateData($request, $slug, $rows, $data);
