...
class HomeServiceProvider extends ServiceProvider
{
    ...
    protected function registerAppServices(): void
    {
        ...
        $this->app->bind(
            \Pedreiro\Services\Image\Contracts\ImageProcessor::class,
            \Pedreiro\Services\Image\ImagineImageProcessor::class
        );

        $this->app->when(\Pedreiro\Services\Image\ImagineImageProcessor::class)
            ->needs('$config')
            ->give(
        ...
        $this->app->bind(
            \Pedreiro\Services\Manifest\Contracts\Manifest::class,
            \Pedreiro\Services\Manifest\AppManifest::class
        );

        $this->app->bind(
            \Pedreiro\Services\SiteMap\Contracts\SiteMapBuilder::class,
            \Pedreiro\Services\SiteMap\AppSiteMapBuilder::class
        );

        $this->app->bind(
            \Pedreiro\Services\Rss\Contracts\RssBuilder::class,
            \Pedreiro\Services\Rss\AppRssBuilder::class
        );
