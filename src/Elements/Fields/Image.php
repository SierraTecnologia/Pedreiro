...
class Image extends File
{
    ...
    protected function renderEditor()
    {
        ...
        $html .= '
			...
			<div class="crop btn js-tooltip active" title="' . __('pedreiro::form.image.crop_tooltip') . '">
			<div class="glyphicon glyphicon-scissors"></div></div>';

        // Will add the focal point ui
        if ($this->add_focal_point) {
            $html .= '<div class="focal btn js-tooltip" title="' . __('pedreiro::form.image.focal_tooltip') . '">
        ...
        $html .= Former::text($this->inputName('title'))
            ...
            ->placeholder(__('pedreiro::form.image.title_placeholder'))
            ->title(__('pedreiro::form.image.title_help'))
            ->render();
